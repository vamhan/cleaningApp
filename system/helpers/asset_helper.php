...
if ( ! function_exists('theme_css'))
{
    function theme_css()
    {
        ...
        $CI =& get_instance();
        //return the full asset path
        return base_url() . $CI->config->item('theme_css');
    }
}
...
if ( ! function_exists('theme_js'))
{
    function theme_js()
    {
        ...
        $CI =& get_instance();
        //return the full asset path
        return base_url() . $CI->config->item('theme_js');
    }
}
...
if ( ! function_exists('theme_images'))
{
    function theme_images()
    {
        ...
        $CI =& get_instance();
        //return the full asset path
        return base_url() . $CI->config->item('theme_images');
    }
}
...
if ( ! function_exists('config_path'))
{
    function config_path()
    {
        //get an instance of CI so we can access our configuration
        $CI =& get_instance();
        return FCPATH . $CI->config->item('config_path');
    }
}
