...
(function ($) {
    ...
    function fnCreateInput(regex, smart, bIsNumber) {
        ...
        var input = $('<input type="text" style="color:#999;" class="h6 form-control ft_search_track  search_init ' + sCSSClass + '" value="' + label + '"/>');
        th.html(input);
        if (bIsNumber)
...
/////////////////////////////////////////////
 function fnCreateInput1(regex, smart, bIsNumber) {
        var sCSSClass = "text_filter";
        if (bIsNumber)
            sCSSClass = "number_filter";
        var input = $('<input type="text" style="color:#999;" class="h6 form-control   search_init ' + sCSSClass + '" value="' + label + '"/>');
        th.html(input);
        if (bIsNumber)
            th.wrapInner('<span class="filter_column filter_number" />');
        else
...
//////////////////////////////////////////////
    ...
    $.fn.columnFilter1 = function (options) {
            ...
            $(sFilterRow + " th", oTable).each(function (index) {
                ...
                if (aoColumn != null) {
                    ...
                    switch (aoColumn.type) {
                        case "number":
                            fnCreateInput1(true, false, true);
                            break;
                        case "text":
                            bRegex = (aoColumn.bRegex == null ? false : aoColumn.bRegex);
                            bSmart = (aoColumn.bSmart == null ? false : aoColumn.bSmart);
                            fnCreateInput1(bRegex, bSmart, false);
                            break;
                        case "select":
