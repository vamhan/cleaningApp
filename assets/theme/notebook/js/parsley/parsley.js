      ...
      type: function (type) {
        ...
        switch (type) {
          case 'email':
            ...
            break;
          case 'dateIso':
            assert = new Validator.Assert().dateIso();
            break;
          case 'phone':
            assert = new Validator.Assert().phone();
            break;
          case 'number':
          ...
          case 'url':
            ...
            break;            
          case 'urlstrict':
            assert = new Validator.Assert().urlstrict();
            break;
          default:
  ...
  ParsleyField.prototype = {
    ...
    */
    ...
    _bindHtml5Constraints: function () {
      ...
      if ('phone' === type)
        return this.addConstraint('type', 'phone', undefined, true);
      if ('dateIso' === type)
        return this.addConstraint('type', 'dateIso', undefined, true);
      if ('urlstrict' === type)
        return this.addConstraint('type', 'urlstrict', undefined, true);
