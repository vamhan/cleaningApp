...
function fetch_slot() {
    ...
    var module_id  = $('input[name="event_category_id"]').val();
...
-->
  ...
  <?php $this->load->view('__employee_track/script/paging_js'); ?>
  <?php $this->load->view('__employee_track/script/delete_js'); ?>
  <?php $this->load->view('__employee_track/script/toggle_menu_project_js'); ?>
