    <?php 
      ...
      if(!empty($result)){
       ...
       if(!empty($query_user)){
          $actor_name = $data_user['user_firstname']." ". $data_user['user_lastname'];
        }else{ $actor_name='-'; }

      //====end :   get actor name =========
    ?>

      <div class="modal fade" id="modal-addListEmployee">
           <!-- #### remark-->
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body" style='overflow:auto'>
                      ...
                      <div class="form-group col-sm-12">
                       ...
                       <div class="col-sm-8">
                          <input type="text" autocomplete="off" class="form-control actor" readonly value="<?php echo $actor_name;  //echo $this->session->userdata('id');?>"> 
