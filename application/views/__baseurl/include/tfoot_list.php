              ...
              <th class="row" colspan="9">
                ...
                <div class="datagrid-footer-right col-sm-8 text-right text-center-xs pull-right" style="visibility: visible;">
                  <div class="grid-pager m-r-n change-page-ft" >
                    ...
                    ?> 
                    <a href="<?php echo site_url($this->page_controller."/listview_complain/".$back_page ); ?>"><button type="button" <?php echo $disabled; ?> class="btn btn-sm btn-default grid-prevpage pull-left" ><i class="fa fa-chevron-left"></i></button></a>
                      ...
                      <div class="input-group dropdown ">
                        ...
                        <div class="input-group-btn dropup">
                          ...
                          <?php for ($i = 1; $i <= $total_page; $i++) { ?>                                        
                                   <li><a href="<?php echo site_url($this->page_controller."/listview_complain/".$i ); ?>"><?php echo $i;?></a></li>
                          <?php } ?> 
                          </ul>
                        </div>
                      </div>
                   ...
                   ?> 
                    ...
                    <!-- <a href="#" data-toggle="modal" class="btn btn-default" ><i class="fa fa-plus"></i> <?php //echo freetext('claim'); ?></a> -->
                     <a  href="<?php echo site_url($this->page_controller.'/detail_complain/insert_complain'); ?>" class="btn btn-default">
                      <i class="fa fa-plus"></i> <?php echo freetext('insert'); ?>
                    </a>
