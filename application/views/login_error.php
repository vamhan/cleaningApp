...
<head>
  <meta charset="utf-8" />
  <title><?php echo 'PSGEN : WEB'; ?></title>
...
<body class="">
    <div class="alert alert-warning alert-block">
        ...
        <p>Your username is not currently in the system. Please contact admin.</p>
        <a class="btn btn-default btn-sm m-t-sm" href="<?php echo '/psgen_web_portal/__portal_controller/index'; ?>">Back to Previous</a>
     </div>
</body>
</html>