  ...
  <form action='' method="POST"> 
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><?php echo freetext('modal-select_equip_tool_return'); ?> </h4>
        </div>
        <div class="modal-body" style='overflow:auto'>
          ...
          <section class="panel panel-default" style="overflow-y: auto;max-height: 350px;">
            <table  class="table" id="table-modal-tool">                 
              ...
              ?>
                <tr class="<?php echo defill($mat['material_no']); ?>">
                  <td>         
                    <div class='radio'>
                      <label>
                        <input type='checkbox' class='radio_tool' name='radio_asset' value="<?php echo defill($mat['material_no']); ?>" data-desc="<?php echo $mat['material_description']; ?>" data-type="<?php echo $mat['material_type'] ?>" data-unit="<?php echo $mat['unit_text']; ?>" data-unitCode="<?php echo $mat['unit_code']; ?>">
                      </label>
                    </div>
                  </td>
              ...
              ?>
                <tr class="<?php echo defill($mat['material_no']); ?>">
                  <td>         
                    <div class='radio'>
                      <label>
                        <input type='checkbox' class='radio_tool' name='radio_asset' value="<?php echo defill($mat['material_no']); ?>" data-desc="<?php echo $mat['material_description']; ?>" data-type="<?php echo $mat['material_type'] ?>" data-unit="<?php echo $mat['unit_text']; ?>" data-unitCode="<?php echo $mat['unit_text']; ?>">
                      </label>
                    </div>
                  </td>
                  <td style="padding-top: 15px;"><?php echo defill($mat['material_no']); ?></td>                    
              ...
              <!-- Start : Asset -->
              <?php
              if (!empty($project_asset_material_list)) {
              ?>
              <tbody class="asset" style="display:none;">  
              <?php
                foreach ($project_asset_material_list as $key => $mat) {
              ?>
                <tr class="<?php echo str_replace('.', '-', $mat['asset_no']); ?>">
                  <td>         
                    <div class='radio'>
                      <label>
                        <input type='checkbox' class='radio_tool' name='radio_asset' value="<?php echo str_replace('.', '-', $mat['asset_no']); ?>" data-id="<?php echo defill($mat['asset_no']); ?>" data-desc="<?php echo $mat['asset_description']; ?>" data-type="<?php echo $mat['material_type'] ?>" data-unit="<?php echo $mat['unit_text']; ?>" data-unitCode="<?php echo $mat['unit_text']; ?>">
                      </label>
                    </div>
                  </td>
                  <td style="padding-top: 15px;"><?php echo defill($mat['asset_no']); ?></td>                    
                  <td style="padding-top: 15px;"><?php echo $mat['asset_description']; ?></td>                                                                                                            
                </tr>
              <?php
                }
              ?>
