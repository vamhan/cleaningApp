            ...
            <tr>
              <th class="row" colspan="10">
                ...
                <div class="datagrid-footer-right col-sm-8 text-right text-center-xs pull-right" style="visibility: visible;">
                  ...
                  ?>
                    <a <?php echo $is_abort; ?> data-cms-action="create" href="#modal-addListEquipment" data-toggle="modal" class="btn btn-default" ><i class="fa fa-plus"></i> <?php echo freetext('add'); ?></a>
                  <?php
                    }
                  ?>                       
                </div>
