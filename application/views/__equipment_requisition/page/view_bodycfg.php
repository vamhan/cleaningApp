          ...
          <div class="row">
            <div class="col-md-4">
              <div class="input-group m-b">
                ...
                <input type="text" readonly autocomplete="off" style="height:42px;" class="form-control doc_id" readonly value="<?php echo $equipment_doc['id']; ?>">
              </div>
            </div>                       
            ...
            <div class="col-md-4">
              <div class="input-group m-b">
                ...
                <input type="text" readonly autocomplete="off" name="create_date" style="height:42px;" class="form-control" readonly value="<?php if( $equipment_doc['actual_date'] !='0000-00-00' ){ echo common_easyDateFormat($equipment_doc['actual_date']); }else{ echo "-"; } //$equipment_doc['actual_date']?> ">
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="input-group m-b">
                ...
                <div class='input-group date col-md-12' id='datetimepicker1' data-date-format="DD-MM-YYYY">
                  <input type='text' style="height:42px;" class="form-control required_date_input" readonly value="<?php if( $equipment_doc['require_date'] !='0000-00-00' ){ echo common_easyDateFormat($equipment_doc['require_date']); }else{ echo date('d-m-Y'); } ?>"/>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="input-group m-b">
                ...
                <input type="text" readonly autocomplete="off" style="height:42px;" class="form-control" readonly value="<?php echo $site_inspector_actor;  ?>">
              </div>
            </div>                       

            <div class="col-md-4">
              <div class="input-group m-b">
                <span style="white-space:normal; height:42px;" class="input-group-addon"><?php echo '<div class="label-width-adon text-left">'.freetext('inspector').'</div>'; ?></span>
                <input type="text" readonly autocomplete="off" style="height:42px;" class="form-control" readonly value="<?php echo $inspector_actor;  ?>">
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="input-group m-b">
                ...
                ?>
                <input type="text" readonly autocomplete="off" name="" style="height:42px;" class="form-control last_requisition_date" readonly  value="<?php echo $last_date;  ?>">                             
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">    
            <div class="col-md-4">
              <div class="input-group m-b">
                ...
                <input type="text" readonly autocomplete="off" style="height:42px;" class="form-control order_type" readonly value="<?php echo freetext($equipment_doc['order_type'].'_'.$equipment_doc['item_category']);  ?>">
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="input-group m-b">
                ...
                <input type="text" readonly autocomplete="off" style="height:42px;" class="form-control sale_order_id" readonly value="<?php echo $equipment_doc['sale_order_id']; ?>">
              </div>
            </div>   
            ...
            <table id="table1" width="100%" class="table text-center table_Z001">                   
              ...
              ?>
                  <tr class="<?php echo defill($equip['material_no']); ?>"> 
                    ...
                    ?>
                      <td>
                        <input type="text" readonly autocomplete="off" class="form-control inline text-right" disabled value="<?php echo $equip['budget']; ?>" style="width:60px;font-size:0.8em;"/>
                      </td>
                    ...
                    ?>                
                    <td>
                      <input type="text" readonly autocomplete="off" class="form-control inline text-right" disabled value="<?php echo $equip['last_count']; ?>" style="width:60px;font-size:0.8em;"/>
                    </td>
                    <td><?php echo $equip['unit_text']; ?></td> 
                    <td>
                      <input type="text" readonly autocomplete="off" class="form-control inline text-right" disabled value="<?php echo $equip['this_count']; ?>" style="width:60px;font-size:0.8em;"/>
                    </td>                    
                    <td><?php echo $equip['unit_text']; ?></td> 
                    <td class="text-left">
                    <?php
                    ...
                    ?>
                      <input type="text" readonly autocomplete="off"<?php echo $disabled; ?> class="form-control inline text-right" name="quantity_<?php echo $equip['material_type'].'_'.defill($equip['material_no']); ?>"  value="<?php echo $equip['add_quantity']; ?>" style="width:65px;font-size:0.8em;"/>
                      <?php
            ...
            <table id="table1" width="100%" class="table text-center table_Z013">                   
              ...
              ?>
                  <tr class="<?php echo defill($equip['material_no']); ?>"> 
                    ...
                    ?>
                      <td>
                        <input type="text" readonly autocomplete="off" class="form-control inline text-right" disabled value="<?php if (!empty($mat_peak_info[$equip['material_no']])) { echo $mat_peak_info[$equip['material_no']]; } else { echo 0; } ?>" style="width:60px;font-size:0.8em;"/>
                      </td>
                      <td><?php echo $equip['unit_text']; ?></td>  
                    <?php
                      }
