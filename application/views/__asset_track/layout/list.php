...
$(document).ready(function(){
    ...
    $('.create_btn').on('click', function() {
      var form       = $('#modal-addListasset form');
...
-->
  ...
  <?php $this->load->view('__asset_track/script/paging_js'); ?>
  <?php $this->load->view('__asset_track/script/delete_js'); ?>
