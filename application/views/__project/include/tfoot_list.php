              ...
              <th class="row" colspan="7">
                  ...
                  <div class="grid-controls pull-left" style="">
                    ...
                    <div class="dropup" data-resize="auto" style="float: left;">
                      ...
                      <ul class="dropdown-menu">
                        <li data-value="10"><a href="<?php echo site_url("__ps_project/changePageSize/10"); ?>" >10</a></li>
                        <li data-value="20"><a href="<?php echo site_url("__ps_project/changePageSize/20"); ?>">20</a></li>
                        <li data-value="50"><a href="<?php echo site_url("__ps_project/changePageSize/50"); ?>">50</a></li>
                        <li data-value="100"><a href="<?php echo site_url("__ps_project/changePageSize/100"); ?>">100</a></li>
                      </ul>
                    </div>
                ...
                <div class="datagrid-footer-right col-sm-4 text-right text-center-xs pull-right" style="visibility: visible;">
                  <div class="grid-pager m-r-n">
                    ...
                    ?> 
                    <a href="<?php echo site_url("__ps_project/listview/list/1/1/1/".$back_page  ); ?>"><button type="button" <?php echo $disabled; ?> class="btn btn-sm btn-default grid-prevpage pull-left" ><i class="fa fa-chevron-left"></i></button></a>
                      ...
                      <div class="input-group dropdown ">
                        ...
                        <div class="input-group-btn dropup">
                          ...
                          <?php for ($i = 1; $i <= $total_page; $i++) { ?>                                        
                                   <li><a href="<?php echo site_url("__ps_project/listview/list/1/1/1/".$i);?>"><?php echo $i;?></a></li>
                          <?php } ?> 
                          </ul>
                        </div>
                      </div>
                   ...
                   ?> 
                    <a href="<?php echo site_url("__ps_project/listview/list/1/1/1/".$next_page ); ?>"><button type="button"  <?php echo $disabled; ?> class="btn btn-sm btn-default grid-nextpage pull-left"><i class="fa fa-chevron-right"></i></button></a>
                  </div>
                </div>
              </th>
            </tr>
