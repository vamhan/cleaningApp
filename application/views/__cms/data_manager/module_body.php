        ...
        <table id="user_permission_table" class="table table-striped datagrid m-b-sm">
                  ...
                  <div class="col-sm-8 m-t-xs m-b-xs pull-right text-right">
                    <div class="input-group search datagrid-search">
                      <div class="input-group-btn">
                        <button class="btn btn-primary btn-sm" data-cms-action="create" data-toggle="modal" data-target="#create_module"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;<?php echo freetext('create_module_btn'); ?></button>
                      </div>
                    </div>
                  </div>
                  <?=form_open('__cms_data_manager/module_management');?>
          ...
          ?>
            <tr>
              ...
              <!-- <START : ACTION SET> -->
              <td class="text-right">
                <a href="#" title="<?php echo freetext('view'); ?>" class="btn btn-default btn-xs" data-toggle="modal" data-target="#module_<?php echo $value['id']; ?>"><i class="fa fa-search"></i></a>
                <a href="#" data-cms-action="update" title="<?php echo freetext('edit'); ?>" data-toggle="modal" data-target="#edit_module_<?php echo $value['id']; ?>" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></a>
                <a href="#" data-cms-action="delete" title="<?php echo freetext('delete'); ?>" data-toggle="modal" data-target="#delete_module_<?php echo $value['id']; ?>" class="btn btn-default btn-xs"><i class="fa fa-trash-o"></i></a>
              </td>
              <!-- <END : ACTION SET> -->
              ...
              <th class="row" colspan="7">
                  ...
                  <div class="grid-controls pull-left" style="">
                    ...
                    <div class="dropup" data-resize="auto" style="float: left;">
                      ...
                      <ul class="dropdown-menu">
                        <li data-value="10"><a href="<?php echo site_url("__cms_page_manager/changePageSize/10"); ?>" >10</a></li>
                        <li data-value="20"><a href="<?php echo site_url("__cms_page_manager/changePageSize/20"); ?>">20</a></li>
                        <li data-value="50"><a href="<?php echo site_url("__cms_page_manager/changePageSize/50"); ?>">50</a></li>
                        <li data-value="100"><a href="<?php echo site_url("__cms_page_manager/changePageSize/100"); ?>">100</a></li>
                      </ul>
                    </div>
                ...
                <div class="datagrid-footer-right col-sm-4 text-right text-center-xs pull-right" style="visibility: visible;">
                  <div class="grid-pager m-r-n">
                    ...
                    ?> 
                    <a href="<?php echo site_url("__cms_page_manager/listview/list/1/1/1/".$back_page  ); ?>"><button type="button" <?php echo $disabled; ?> class="btn btn-sm btn-default grid-prevpage pull-left" ><i class="fa fa-chevron-left"></i></button></a>
                      ...
                      <div class="input-group dropdown ">
                        ...
                        <div class="input-group-btn dropup">
                          ...
                          <?php for ($i = 1; $i <= $total_page; $i++) { ?>                                        
                                   <li><a href="<?php echo site_url("__cms_page_manager/listview/list/1/1/1/".$i);?>"><?php echo $i;?></a></li>
                          <?php } ?> 
                          </ul>
                        </div>
                      </div>
                   ...
                   ?> 
                    <a href="<?php echo site_url("__cms_page_manager/listview/list/1/1/1/".$next_page ); ?>"><button type="button"  <?php echo $disabled; ?> class="btn btn-sm btn-default grid-nextpage pull-left"><i class="fa fa-chevron-right"></i></button></a>
                  </div>
                </div>
              </th>
            </tr>
