                        ...
                        <th colspan="7">
                          <div class="row">
                            ...
                            ?> 
                              ...
                              <a href='#modal-auth' data-toggle="modal" class='pull-right btn-sm btn btn-warning list-extend-button' style="margin-left:2px; font-weight:bold"><i class='fa fa-cogs'></i> &nbsp; Auth Management</a>
                              <a class='pull-right btn-sm btn-dark btn group-delete-button' style="margin-left:2px;"><?php echo freetext('delete'); ?></a>
                              <a href="#modal-form" class="" data-toggle="modal"><button class='pull-right btn-sm btn-primary btn'><i class='fa fa-plus-circle'></i>&nbsp;&nbsp;<?php echo freetext('create_new_api'); ?></button></a>                                                   
                            </div>
                    ...
                    ?>
                      <tr> 
                        ...
                        <td style='text-align:right'>
                          ...
                          <!-- </a> -->
                          <a class="btn btn-default" target='_blank' href="<?php echo site_url($this->page_controller.'/detail/view/'.$value['id']) ?>" data-toggle=""><i class="fa fa-pencil"></i></a>
