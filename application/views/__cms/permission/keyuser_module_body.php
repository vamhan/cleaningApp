        ...
        <table id="group_permission_table" class="table table-striped datagrid m-b-sm">
          <thead>
                  ...
                  <div class="col-sm-8 m-t-xs m-b-xs pull-right text-right">
                    <div class="input-group search datagrid-search">
                      <div class="input-group-btn">
                        <button class="btn btn-primary btn-sm" data-cms-action="create" data-toggle="modal" data-target="#create_key_user"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;<?php echo freetext('create_key_user_btn'); ?></button>
                      </div>
                    </div>
                  </div>                  
                </div>
            ...
            <tr>
              ...
              <th class="table-head"><?php echo freetext('employee_name'); ?></th>
              <th class="table-head"></th>
            </tr>
          </thead>
          <tbody>
          ...
          ?>
            <tr>
              ...
              <?php //Rendering value 
              if(!empty($value)){
                $td = '<td class="table-division">'.freetext($value['module_name']).'</td>';
                $td .= '<td class="table-division">'.$value['user_firstname'].' '.$value['user_lastname'].'</td>';
                echo $td;
              }//end if 
              ?>
              <!-- <START : ACTION SET> -->
              <td class="text-right">
                <a href="#" data-cms-action="update" title="<?php echo freetext('edit'); ?>" data-toggle="modal" data-target="#edit_keyuser_module_<?php echo $value['id']; ?>" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></a>
                <a href="#" data-cms-action="delete" title="<?php echo freetext('delete'); ?>" data-toggle="modal" data-target="#delete_keyuser_module_<?php echo $value['id']; ?>" class="btn btn-default btn-xs"><i class="fa fa-trash-o"></i></a>
              </td>
              <!-- <END : ACTION SET> -->
              ...
              <th class="row" colspan="7">
                ...
                <div class="datagrid-footer-right col-sm-4 text-right text-center-xs pull-right" style="visibility: visible;">
                  <div class="grid-pager m-r-n">
                    ...
                    ?> 
                    <a href="<?php echo site_url("__cms_permission/key_user_list/".$back_page  ); ?>"><button type="button" <?php echo $disabled; ?> class="btn btn-sm btn-default grid-prevpage pull-left" ><i class="fa fa-chevron-left"></i></button></a>
                      ...
                      <div class="input-group dropdown ">
                        ...
                        <div class="input-group-btn dropup">
                          ...
                          <?php for ($i = 1; $i <= $total_page; $i++) { ?>                                        
                                   <li><a href="<?php echo site_url("__cms_permission/key_user_list/".$i);?>"><?php echo $i;?></a></li>
                          <?php } ?> 
                          </ul>
                        </div>
                      </div>
                   ...
                   ?> 
                    <a href="<?php echo site_url("__cms_permission/key_user_list/".$next_page ); ?>"><button type="button"  <?php echo $disabled; ?> class="btn btn-sm btn-default grid-nextpage pull-left"><i class="fa fa-chevron-right"></i></button></a>
                  </div>
                </div>
              </th>
            </tr>
