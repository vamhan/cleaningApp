...
<body class="">
  <section id="content" class="m-t-lg wrapper-md animated fadeInUp">    
    <div class="container aside-xxl">
      <a class="navbar-brand block"><?php echo $this->project_config['title']/*.freetext('category_title')*/; ?></a>
      <section class="panel panel-default bg-white m-t-lg">
        ...
        <form method="post"  action="<?php echo site_url('__cms_permission/login/mobile'); ?>" class="panel-body wrapper-lg">
          <div class="form-group">
            <label class="control-label">Mobile Code</label>
            <input type="text" autocomplete="off" placeholder="" name="short_token" class="form-control input-lg">
          </div>
