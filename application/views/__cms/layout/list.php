...
<body class="">
  ...
  <script src="<?php echo theme_js().'parsley/parsley.extend.js';?>"></script>
 ...
 <script src="<?php echo theme_js().'build_datepicker/bootstrap-datetimepicker.js'?>"></script>
  ...
  <script src="<?php echo js_url().'bootstrap-switch.js'; ?>"></script>
...
$(".input-page").keyup(function (e) {
    if (e.keyCode == 13) {
       ...
       // alert(totalPage);
        var location1 = '<?php echo site_url("__cms_page_manager/listview/list/1/1/1/'+inputPage+'" ); ?>';
        var location2 ='<?php echo site_url("__cms_page_manager/listview/list/1/1/1/'+totalPage+'" ); ?>';
...
-->
  ...
  <?php $this->load->view('__cms/script/paging_js'); ?>
  <?php $this->load->view('__cms/script/delete_js'); ?>
