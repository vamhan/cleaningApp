...
<head>
	...
	<link rel="stylesheet" href="<?php echo theme_css().'docxtemplater_main.css'; ?>">

	<!-- Mandatory js for the library to work -->
	<script type="text/javascript" src="<?php echo theme_js().'docxtemplater/browser/main.min.js';?>"></script>
	<script src="<?php echo theme_js().'docxtemplater/build/angular-expressions.js';?>"></script>
  ...
  -->
  <!--[if IE]>
  <script type="text/javascript" src="<?php echo theme_js().'docxtemplater/vendor/jszip-utils-ie.js';?>"></script>
  <![endif]-->

	<!-- Include this only if you want to use downloadify (last example) -->
	<script src="<?php echo theme_js().'docxtemplater/vendor/downloadify/js/downloadify.min.js';?>"></script>
	<script src="<?php echo theme_js().'docxtemplater/vendor/downloadify/js/swfobject.js';?>"></script>
</head>
<body>
