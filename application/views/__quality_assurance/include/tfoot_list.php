                  ...
                  <div class="grid-pager m-r-n change-page-ft" >
                   ...
                   ?> 
                    <a href="<?php echo site_url("__ps_employee_track/listview/list/".$project_id."/1/1/".$next_page ); ?>"><button type="button"  <?php echo $disabled; ?> class="btn btn-sm btn-default grid-nextpage pull-left"><i class="fa fa-chevron-right"></i></button></a>
                     ...
                     <?php if ($isAllowToCreate == 1 && array_key_exists('create', $permission)) { ?><a data-cms-visible="create" href="#modal-addListEmployee" data-toggle="modal" class="btn btn-default" ><i class="fa fa-plus"></i> <?php echo freetext('add'); ?></a><?php } ?>
